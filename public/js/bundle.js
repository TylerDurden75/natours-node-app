...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmF5dGkiLCJhIjoiY2t2Z3BwMWYzMWJwNTMwbjN6djRxMHZsNiJ9.1oTHB80Hc-LzYfb-gPhuwQ';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            // if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Account created successfully! Please check your email to verify it.');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500); // }
...
exports.updateReview = exports.submitReview = exports.deleteReview = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(rating, review, tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", (0, _alert.showAlert)('error', 'You have already added a review!🙂'));
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(reviewId, rating, review) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Review updated successfuly!', 2);
              window.setTimeout(function () {
                location.reload();
              }, 2000);
            }
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(reviewId) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (!res.data) {
              (0, _alert.showAlert)('success', 'Review deleted successfully!', 1);
              window.setTimeout(function () {
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JrfWpHnTp5rTBTLu2uVE7Mkd5wc278M15QKm7oelYmxSCO187bZ7FJuwBAfJDIhaCyQDzriGKGvSHlNEL4Q252u00GdrbMbb8');
            _context.prev = 1;
            _context.next = 4;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"favorite.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(tourId, toggleBtn) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', 'Tour added to favorite');
            }
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(tourId, toggleBtn) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (!res.data) {
              (0, _alert.showAlert)('success', 'Tour removed from favorite');
              toggleBtn.toggle('favorite-on');
            }
...
var reviewPage = document.getElementById('review__page'); // DELEGATION
